...
export const JOURNEY_STEPS: JourneyStep[] = [
  {
    ...
    acceptance: [
      ...
      "5180 Phase 16–17 手测见 /review/step/phase16-17",
  ...
  },
  {
    ...
    acceptance: [
      ...
      "Phase 16–17 浏览器手测见 /review/step/phase16-17",
  ...
  },
  {
    id: "phase16-17",
    order: 10.6,
    title: "Phase 16–17 手测",
    targetPath: "/search",
    summary: "5180 上 Walkthrough 步骤 C §7（Citation）+ D（检索高亮）；通过后归档 §5。",
    acceptance: [
      "基址 http://<host>:5180（非 5174 dev）",
      "步骤 C §7：对话页 Citation 可展开且与引用一致",
      "步骤 D：/search 检索结果高亮与预期一致",
      "bash scripts/tbox_phase16_17_handtest.sh 清单全部勾选",
      "bash scripts/tbox_phase16_17_finish.sh --archive 更新 VM 验收 §5",
    ],
  },
  {
    id: "errors",
