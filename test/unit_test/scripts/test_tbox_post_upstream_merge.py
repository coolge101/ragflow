...
class TestPostUpstreamMerge(unittest.TestCase):
    ...
    def test_post_merge_prints_phase16_17_chain(self) -> None:
        ...
        self.assertIn("TBOX_QUICKSTART.md", self.post_merge_text)
        self.assertIn("TBOX_DEPLOY_RUNBOOK.md", self.post_merge_text)
        self.assertIn("step D", self.post_merge_text)
        self.assertIn("tbox_pre_release.sh --help", self.post_merge_text)
    ...
    def test_upstream_runbook_section32_phase16_17(self) -> None:
        ...
        self.assertIn("TBOX_DEPLOY_RUNBOOK.md", section)
