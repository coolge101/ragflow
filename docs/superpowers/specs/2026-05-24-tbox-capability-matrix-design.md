...
| G2-CRAWL-RELEVANCE | 入库前相关性评分（LLM/规则） | ❌ | ✅ Phase 69.3 | TBOX ingest | P2 | **`common/tbox_crawl_relevance.py`**；规则/LLM 闸门 |
...
| G5-MATRIX | 本能力矩阵维护 | — | 本文 | — | **P0** | Phase 66 @ `8e3ebc572`；§6 Phase 0–66；Harness §9.0 同步 |
...
| **58** | QUICKSTART §1.3 + handtest 手册 | 运维/产品 | §1.3 ↔ helper + **`tbox_phase16_17_handtest.sh`** §5.4 — phase58 plan |
| **59** | finish + SMOKE_ENV §1.3 | 运维/产品 | **`tbox_phase16_17_finish.sh`** + SMOKE_ENV Phase 16–17 — phase59 plan |
...
| **64** | UPSTREAM §3.2 + post_merge | 运维/产品 | merge Runbook §3.2 ↔ §8.1 + **`tbox_post_upstream_merge.sh`** — phase64 plan |
...
| 2026-05-31 | §6 Phase 66；SMOKE_SCRIPTS S6 专节 + QUICKSTART §1.2 ↔ DEPLOY §6/§8 — phase66 |
| 2026-05-31 | §6 Phase 65；s6_preflight ↔ post_merge + DEPLOY_FROM_GITHUB §6/§8 — phase65 |
| 2026-05-31 | §6 Phase 64；UPSTREAM §3.2 ↔ Runbook §8.1 + post_merge QUICKSTART §1.3 — phase64 |
| 2026-05-31 | §6 Phase 63；Runbook §3.1.3/§8.1 + Harness 54–62 摘要 — phase63 |
| 2026-05-31 | §6 Phase 62；setup_smoke_env + Walkthrough §2.1 VM/SMOKE — phase62 |
| 2026-05-31 | §6 Phase 61；VM §5 ↔ SMOKE_SCRIPTS + smoke.env.example — phase61 |
| 2026-05-31 | §6 Phase 60；SMOKE_SCRIPTS ↔ SMOKE_ENV + archive QUICKSTART §1.3 — phase60 |
...
| 2026-05-31 | §6 Phase 55；host_check 与 web_tbox_check 对齐 + Walkthrough D handtest — phase55 |
| 2026-05-31 | §6 Phase 54；web_tbox_check phase16-17 提示 + Harness 51–53 摘要 — phase54 |
| 2026-05-31 | §6 Phase 53；web-tbox README + 手册 §5.4 ↔ ENV §6 — phase53 |
