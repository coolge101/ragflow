...
| 方向 | 说明 |
|------|------|
| **采集高级策略** | ✅ P1：关键词/深度/域名 + worker。**下一阶段 P1（Phase 67）**：**四类专题库**（法规与标准、技术趋势、市场趋势、产品/行业情报）均需 **全网发现（DISCOVER）+ 智能去重（DEDUP）+ 中英文（I18N）** — 矩阵 §6 · plan · **`TBOX_5180_HANDTEST_2026-06-02.md`**。 |
