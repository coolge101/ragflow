...
| **矩阵/里程碑** | **Phase 0–8 ✅** | 见 **`phase3`–`phase8-plan`**；**Phase 9**（VM 验收 + G1 向导）见 **[`2026-05-24-tbox-phase9-plan.md`](./superpowers/plans/2026-05-24-tbox-phase9-plan.md)**。后续：**S6 定期 merge** + **发版 smoke**。 |
