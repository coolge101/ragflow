...
| 2026-05-01 | **§1.3**：**`RSSConnector`** Feed 拉取（**`ingest_rss_seeds_into_kb`**）对齐 **hop robots**、**`OriginFetchThrottler`**、**408/429/502/503/504 退避** 与 **`TBOX_CRAWL_HTTP_USER_AGENT`** |
