...
| 2026-05-24 | **§1.2–1.4**：**`source_type=http_api`**；**`tbox_crawl_auth_profile`** + env **`TBOX_CRAWL_AUTH_<PROFILE>_HEADERS`**（G2-CRAWL-AUTH）；API JSON 映射键与 **`ingest_http_api_seeds_into_kb`**（G2-CRAWL-API）；**`web-tbox` `/crawl`** 高级源表单 |
