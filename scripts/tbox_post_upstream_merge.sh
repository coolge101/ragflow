...
echo "       (Walkthrough step D 5180 准生产前置; see scripts/tbox_smoke.env.example)"
...
echo "    Doc: docs/TBOX_QUICKSTART.md §1.3 · docs/TBOX_DEPLOY_RUNBOOK.md §8.1"
echo "         docs/TBOX_UI_ACCEPTANCE_WALKTHROUGH.md (step D) · docs/TBOX_SMOKE_SCRIPTS.md"
echo "         docs/TBOX_SMOKE_ENV.md · docs/TBOX_UPSTREAM_MERGE_RUNBOOK.md §3.2"
